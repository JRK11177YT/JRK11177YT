...
### 🛩️ Bandits ESP — Escuadrón de Simulación Aérea
> Plataforma de gestión operacional para escuadrones de DCS World
...
### 🏢 Ibercenter — Desarrollo Interno
> Trabajo como desarrollador dando soporte a la infraestructura digital de la empresa
 
- 🌐 **Web principal:** apoyo en el mantenimiento y evolución de la página pública de la empresa (rendimiento, SEO on-page, resolución de incidencias)
- 🗂️ **Gestión de salas:** desarrollo de una aplicación propia para la gestión de salas en los distintos centros
- ⚙️ Trabajo tanto en frontend como en backend según las necesidades de cada proyecto
---
...
- [ ] 🤖 Publicar el bot Bandit con panel de administración web
- [ ] 🏢 Consolidar el desarrollo en Ibercenter (web principal + gestión de salas)
- [ ] 🏗️ Desplegar proyectos en servidor propio (Windows Server + VMs)
- [ ] 📡 Profundizar en administración de redes y virtualización
